...
<section>
    <div class="container">
        <div class="text-justify">
            <p class="card-text">Les meubles sont chinés et bichonnés avant d'être relookés avec amour et savoir-faire selon mes envies et inspirations.<br /> Etant anciens, subsistent les marques du temps qui font leur charme et son gages de leur histoire.<br />Ici tout est possible ! Vous rêvez d'un meuble unique et personnalisé ? Je le chine pour vous et nous choisissons ensemble les couleurs. <a href="index.php?action=contact">Contactez-moi</a> afin que nous échangions sur votre projet.<br />Vous possédez déjà un meuble de famille mais il nest plus à votre goût ? Je lui referai une petite beauté avec plaisir.<a href="index.php?action=contact"> Contactez-moi </a>afin que je vous proposeun devis.</p>  
        </div>
    </div>    
